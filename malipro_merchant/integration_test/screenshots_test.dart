// Captures d'écran automatisées — NOVIGO Marchand (login par mot de passe).
...
import 'package:malipro_merchant/main.dart' as app;

const String demoPhone = String.fromEnvironment('DEMO_PHONE', defaultValue: '+22376000001');
...
void main() {
  ...
  testWidgets('NOVIGO Marchand — captures', (tester) async {
    app.main();
