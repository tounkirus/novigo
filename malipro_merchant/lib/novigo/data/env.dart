/// Configuration runtime de l'app marchand NOVIGO.
///
...
class NovigoEnv {
  ...
  // Identifiants démo (login = téléphone + mot de passe). Marchand seedé.
  static const String demoPhone =
      String.fromEnvironment('NOVIGO_PHONE', defaultValue: '+22376000000');
