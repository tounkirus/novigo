...
/// Flux des événements commande poussés (order.new / order.updated).
final realtimeOrderEventsProvider = StreamProvider<Map<String, dynamic>>((ref) {
  return ref.watch(realtimeServiceProvider).orderEvents;
});
