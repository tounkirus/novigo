...
class ChatRepository {
  ...
  /// Récupère l'ID client d'une commande (pour ouvrir une conversation livreur↔client).
  Future<String?> orderCustomerId(String orderId) async {
    final o = await _api.get('/orders/$orderId') as Map<String, dynamic>;
    return o['customerId'] as String?;
  }
}
