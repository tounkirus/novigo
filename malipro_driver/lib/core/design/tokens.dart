...
class MaliColors {
  ...
  /// Couleur primaire (nom `emerald` conservé pour compat). // NOVIGO rouge
  static const emerald = Color(0xFFE53935); // NOVIGO rouge
  static const emeraldDark = Color(0xFFC62828); // NOVIGO rouge-foncé
  static const emeraldLight = Color(0xFFFF5A5F); // NOVIGO rouge-clair
