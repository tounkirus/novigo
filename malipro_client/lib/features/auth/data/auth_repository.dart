...
class AuthRepository {
  ...
  /// Déclenche l'envoi de l'OTP (backend P1 : /auth/register).
  Future<void> requestOtp(String phone) async {
    await _api.post('/auth/register', body: {'phone': phone, 'role': 'CUSTOMER'});
  }

  /// Vérifie l'OTP et renvoie les tokens (+ user). Backend P1 : /auth/verify-otp.
  Future<Map<String, dynamic>> verifyOtp(String phone, String code) async {
    final data = await _api.post('/auth/verify-otp', body: {'phone': phone, 'code': code});
    return data as Map<String, dynamic>;
  }

  /// Chemin alternatif disponible dès aujourd'hui (backend prêt) : mot de passe.
